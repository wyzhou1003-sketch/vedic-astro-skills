...
工作时间：23:20（白羊28°27'）
验前事3/5 → 建议vedic-rectifier进一步校准（用户决定中）
```
...
D1  ✅ 启用
D9  ✅ 启用
D10 ⚠️ 启用但仅供参考（时间精度有限）
D5  ⚠️ 启用但仅供参考
D4  ⚠️ 启用但仅供参考
提示：Lagna在28°27'(>28°边界区) + ±15分钟 → 分盘对时间敏感，
如core分析感觉偏差较大，建议vedic-rectifier精确校准。
经rectifier校准后D10/D5/D4可升级为完全启用。
```
